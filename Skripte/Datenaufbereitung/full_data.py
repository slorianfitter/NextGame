...
base = pd.read_csv("D:/Projekte/spielvorschlag/data/wanted_information.csv")
...
RaT = pd.read_csv("D:/Projekte/spielvorschlag/data/review_alltime.csv")
...
pd.Series(tags_list, name="tag_name").to_csv("D:/Projekte/spielvorschlag/data/all_tags_for_games.csv", index=False)
...
pd.Series(feature_list, name="feature_name").to_csv("D:/Projekte/spielvorschlag/data/alle_features_bei_steam.csv", index=False)
...
pd.Series(genre_list, name="genre_name").to_csv("D:/Projekte/spielvorschlag/data/alle_genres_bei_steam.csv", index=False)
...
pd.Series(category_list, name="category_name").to_csv("D:/Projekte/spielvorschlag/data/alle_categories_bei_steam.csv", index=False)
...
finished = merged_df
finished.to_csv("D:/Projekte/spielvorschlag/data/full_data.csv", index=False) # Schnellster und einfachster weg. Mit Excel hat es nicht gegklappt bzw. hat ewig gedauert.
...
#finished.to_excel("D:/Projekte/spielvorschlag/data/full_data.xlsx", engine="xlsxwriter", index=False)